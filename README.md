...
See [Security Requirements](docs/plans/swirling-sleeping-kahan.md) for comprehensive security documentation.
...
VaultClip was created after a [comprehensive security analysis](docs/plans/swirling-sleeping-kahan-agent-a6dc72ea.md) revealed critical vulnerabilities in existing clipboard managers.
...
- [Security Requirements](docs/plans/swirling-sleeping-kahan.md) - Comprehensive security design document
- [Security Analysis of Clipy](docs/plans/swirling-sleeping-kahan-agent-a6dc72ea.md) - Research that motivated VaultClip
...
VaultClip builds on lessons learned from excellent open-source clipboard managers like Clipy and Maccy, while addressing their security limitations with modern cryptographic practices and defense-in-depth architecture.
